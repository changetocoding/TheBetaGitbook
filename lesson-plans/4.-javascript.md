...
# Recommendations:
- This should be a very interactive session
...
# Teacher instruction 
Create a lesson plan from the course materials above and around basic javascript information.

Explain a bit of coding then get the students to do an exercise from the Udacity course  https://classroom.udacity.com/courses/ud803 
...
- https://classroom.udacity.com/courses/ud803 - For student excerises
