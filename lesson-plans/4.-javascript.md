...
This is a relatively easy day for the teacher: The students will mostly self learn through the udacity course 

* In the first lesson explain a bit of javascript then:
* Students go through udacity course \([https://classroom.udacity.com/courses/ud803](https://classroom.udacity.com/courses/ud803)\)
* In every 1.5 hr session, give students roughly 1 hour to go through course. Then spend 15 minutes checkpointing them to ensure they stay on track.. Mini quiz \(e.g. multiple choice questions\), go over bits that class is struggling with.
* In a session on day 2 give them the [Fizz buzz](4.-javascript.md#class-ex-fizz-buzz) challenge \(see below\). Should take 30 mins-1hr to complete. This tests their knowledge of selection \(if statements\) and iteration \(for loops\). 
* Make sure you cover button click and using js to redirect page. They'll need it for the end of course project
